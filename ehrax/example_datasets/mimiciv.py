...
class CodedSQLTableConfig(SQLTableConfig, CodedTableConfig):
    ...
    def __init__(self, code_alias: str, description_alias: str, query_template: Optional[str] = None,
        ...
        SQLTableConfig.__init__(self, query_template=query_template)
...
class AdmissionTimestampedMultiColumnSQLTableConfig(SQLTableConfig,
    ...
    def __init__(self, query_template: str, admission_id_alias: str = 'admission_id', time_alias: str = 'time', *,
                 name: str, attributes: tuple[str, ...],
                 type_hint: Optional[tuple[NumericalTypeHint, ...]] = None,
                 default_type_hint: NumericalTypeHint = 'N'):
        AdmissionTimestampedMultiColumnTableConfig.__init__(self, admission_id_alias=admission_id_alias,
...
class AdmissionTimestampedCodedValueSQLTableConfig(CodedSQLTableConfig, AdmissionTimestampedCodedValueTableConfig):
    components: tuple[AdmissionTimestampedMultiColumnSQLTableConfig, ...]
    admission_id_alias: str = 'admission_id'
    time_alias: str = 'time'
    ...
    def __init__(self, components: tuple[AdmissionTimestampedMultiColumnSQLTableConfig, ...],
                 code_alias: str = 'code',
                 description_alias: str = 'description', *,
                 admission_id_alias: str = 'admission_id',
                 time_alias: str = 'time',
                 value_alias: str = 'value',
                 space_query_template: Optional[str] = None):
        CodedSQLTableConfig.__init__(self, code_alias=code_alias, description_alias=description_alias,
                                     query_template='',
                                     space_query_template=space_query_template)
        AdmissionTimestampedCodedValueTableConfig.__init__(self, admission_id_alias=admission_id_alias,
                                                           time_alias=time_alias, value_alias=value_alias,
                                                           code_alias=code_alias, description_alias=description_alias)
...
class AdmissionSQLTableConfig(SQLTableConfig, AdmissionTableConfig):
    ...
    def __init__(self, query_template: Optional[str] = None, subject_id_alias: str = 'subject_id',
                 admission_id_alias: str = 'admission_id',
                 admission_time_alias: str = 'admission_time', discharge_time_alias: str = 'discharge_time'):
        SQLTableConfig.__init__(self, query_template=query_template)
        AdmissionTableConfig.__init__(self, subject_id_alias=subject_id_alias,
...
class StaticSQLTableConfig(SQLTableConfig, StaticTableConfig):
    ...
    anchor_year_alias: str
    anchor_age_alias: str
    subject_id_alias: str
    gender_alias: str
    date_of_birth_alias: str
    race_alias: str

    def __init__(self, subject_id_alias: str = 'subject_id', gender_alias: str = 'gender',
                 date_of_birth_alias: str = 'date_of_birth',
                 race_alias: str = 'race', query_template: Optional[str] = None, anchor_year_alias: str = 'anchor_year',
                 anchor_age_alias: str = 'anchor_age', *,
                 gender_space_query_template: str, race_space_query_template: str):
        SQLTableConfig.__init__(self, query_template=query_template)
        StaticTableConfig.__init__(self, subject_id_alias=subject_id_alias, gender_alias=gender_alias,
                                   date_of_birth_alias=date_of_birth_alias,
                                   race_alias=race_alias)
        self.anchor_year_alias = anchor_year_alias
        self.anchor_age_alias = anchor_age_alias
...
class AdmissionMixedICDSQLTableConfig(AdmissionLinkedCodedValueTableConfig, CodedSQLTableConfig):
    ...
    def __init__(self, admission_id_alias='admission_id', code_alias: str = 'code',
                 description_alias: str = 'description', query_template: Optional[str] = None,
                 space_query_template: Optional[str] = None,
                 icd_code_alias: str = 'icd_code', icd_version_alias: str = 'icd_version'):
        AdmissionLinkedCodedValueTableConfig.__init__(self, admission_id_alias=admission_id_alias,
                                                      code_alias=code_alias, description_alias=description_alias)
        CodedSQLTableConfig.__init__(self, query_template=query_template, code_alias=code_alias,
                                     description_alias=description_alias,
                                     space_query_template=space_query_template)
        self.icd_code_alias = icd_code_alias
        self.icd_version_alias = icd_version_alias
...
class IntervalICUProcedureSQLTableConfig(CodedSQLTableConfig, AdmissionIntervalBasedCodedTableConfig):
    ...
    def __init__(self, admission_id_alias='admission_id', code_alias: str = 'code',
                 description_alias: str = 'description',
                 start_time_alias: str = 'start_time', end_time_alias: str = 'end_time',
                 query_template: Optional[str] = None, space_query_template: Optional[str] = None, ):
        CodedSQLTableConfig.__init__(self, query_template=query_template, code_alias=code_alias,
                                     description_alias=description_alias, space_query_template=space_query_template)
...
class RatedInputSQLTableConfig(CodedSQLTableConfig, RatedInputTableConfig):
    ...
    def __init__(self, admission_id_alias='admission_id', amount_alias='amount',
                 amount_unit_alias='amount_unit', start_time_alias='start_time',
                 end_time_alias='end_time', code_alias='code',
                 description_alias='description', derived_normalized_amount='derived_normalized_amount',
        ...
        RatedInputTableConfig.__init__(self, admission_id_alias=admission_id_alias,
                                       start_time_alias=start_time_alias,
                                       end_time_alias=end_time_alias,
                                       code_alias=code_alias, description_alias=description_alias,
                                       amount_alias=amount_alias, amount_unit_alias=amount_unit_alias,
...
class TimestampedMultiColumnSQLTable(SQLTable):
    ...
    def __init__(self, config: AdmissionTimestampedMultiColumnSQLTableConfig):
...
class MIMICIVDatasetSchemeSuffixes(AbstractConfig):
    gender: str
    ethnicity: str
    dx_discharge: str
    obs: str
...
class DatasetSchemeMapsFiles(AbstractConfig):
    gender: Optional[str]
    ...
    def __init__(self, gender: Optional[str] = 'gender.csv',
...
class DatasetSchemeSelectionFiles(AbstractConfig):
    ...
    def __init__(self, gender: str = 'gender.csv', ethnicity: str = 'ethnicity.csv',
                 icu_inputs: str = 'icu_inputs.csv', icu_procedures: str = 'icu_procedures.csv',
                 hosp_procedures: str = 'hosp_procedures.csv', obs: str = 'obs.csv',
                 dx_discharge: str = 'dx_discharge.csv'):
        self.gender = gender
        self.ethnicity = ethnicity
        self.icu_inputs = icu_inputs
        self.icu_procedures = icu_procedures
...
class MIMICIVDatasetSchemeConfig(DatasetSchemeConfig):
    suffixes: MIMICIVDatasetSchemeSuffixes
    name_separator: str
    name_prefix: str
    resources_dir: str
    ...
    def __init__(self, suffixes: MIMICIVDatasetSchemeSuffixes = MIMICIVDatasetSchemeSuffixes(),
                 name_separator: str = '.', name_prefix: str = 'mimiciv', resources_dir: str = 'mimiciv',
        ...
        DatasetSchemeConfig.__init__(self, ethnicity=ethnicity, dx_discharge=dx_discharge, obs=obs,
                                     gender=gender, icu_inputs=icu_inputs, icu_procedures=icu_procedures,
                                     hosp_procedures=hosp_procedures)
        self.suffixes = suffixes
        self.name_separator = name_separator
        self.name_prefix = name_prefix
        self.resources_dir = resources_dir
        self.selection_subdir = selection_subdir
        self.map_subdir = map_subdir
        self.map_files = map_files
        self.selection_files = selection_files
...
class StaticSQLTable(SQLTable):
    ...
    def __init__(self, config: StaticSQLTableConfig):
        super().__init__(config)
...
class MIMICIVSQLTablesInterface(AbstractVxData):
    # TODO: Document this class.
    ...
    def register_dx_discharge_scheme(self, manager: CodingSchemesManager,
        ...
        return table.register_scheme(manager, config.dx_discharge, self.create_engine(),
                                     FrozenDict11({'9': 'dx_icd9', '10': 'dx_flat_icd10'}),
    ...
    def _extract_dx_discharge_table(self, engine: Engine, manager: CodingSchemesManager,
    ...
    def _extract_hosp_procedures_table(self,
                                       engine: Engine, manager: CodingSchemesManager,
    ...
    def load_tables(self, dataset_scheme: DatasetSchemeProxy) -> DatasetTables:
        ...
        dx_discharge = self._extract_dx_discharge_table(self.create_engine(), dataset_scheme.schemes_context,
...
class MIMICIVDataset(Dataset):
    ...
    @classmethod
    def load_tables(cls, config: MIMICIVSQLConfig, scheme: DatasetSchemeProxy) -> DatasetTables:
        sql = MIMICIVSQLTablesInterface(config.tables)
