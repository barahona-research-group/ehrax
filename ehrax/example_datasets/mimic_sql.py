...
class SQLTableResource(TableResource):
    ...
    def __init__(self, columns: TableColumns, query_template: Optional[str] = None):
...
DX_DISCHARGE_CONF = SQLMixedICDTableResource(query_template="mimiciv/sql/dx_discharge.tsql",
                                             space_query_template="mimiciv/sql/dx_discharge_space.tsql")

RENAL_OUT_CONF = SQLMultivariateTimeSeriesResource(name="renal_out",
                                                   attributes=('uo_rt_6hr', 'uo_rt_12hr', 'uo_rt_24hr'),
                                                   query_template="mimiciv/sql/renal_out.tsql")

RENAL_CREAT_CONF = SQLMultivariateTimeSeriesResource(name="renal_creat",
                                                     attributes=('creat',),
...
BLOOD_GAS_CONF = SQLMultivariateTimeSeriesResource(name="blood_gas",
                                                   attributes=BLOOD_GAS_ATTRIBUTES,
                                                   query_template="mimiciv/sql/blood_gas.tsql")

BLOOD_CHEMISTRY_CONF = SQLMultivariateTimeSeriesResource(name="blood_chemistry",
...
CARDIAC_MARKER_CONF = SQLMultivariateTimeSeriesResource(name="cardiac_marker",
                                                        attributes=('troponin_t2', 'ntprobnp', 'ck_mb'),
                                                        query_template="mimiciv/sql/cardiac_marker.tsql")

WEIGHT_CONF = SQLMultivariateTimeSeriesResource(name="weight",
                                                attributes=('weight',),
                                                query_template="mimiciv/sql/weight.tsql")

CBC_CONF = SQLMultivariateTimeSeriesResource(name="cbc",
...
VITAL_CONF = SQLMultivariateTimeSeriesResource(name="vital",
...
GCS_CONF = SQLMultivariateTimeSeriesResource(name="gcs",
...
ICP_CONF = SQLMultivariateTimeSeriesResource(name="icp",
                                             attributes=('icp',),
                                             query_template="mimiciv/sql/icp.tsql")

# Inflammation
INFLAMMATION_CONF = SQLMultivariateTimeSeriesResource(name="inflammation",
                                                      attributes=('crp',),
                                                      query_template="mimiciv/sql/inflammation.tsql")

# Coagulation
COAGULATION_CONF = SQLMultivariateTimeSeriesResource(name="coagulation",
...
BLOOD_DIFF_CONF = SQLMultivariateTimeSeriesResource(name="blood_diff",
...
# Enzymes
ENZYMES_CONF = SQLMultivariateTimeSeriesResource(name="enzymes",
...
class SQLMIMICTablesResources(DatasetTablesResources):
    ...
    def __init__(self, static: SQLStaticTableResource = STATIC_CONF,
