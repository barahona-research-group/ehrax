...
from ehrax.tvx_ehr import TVxEHR, TVxReport, TVxEHRSampleConfig, ScalerConfig, \
...
from ehrax.tvx_transformations import SampleSubjects, CodedValueScaler, ObsAdaptiveScaler, InputScaler, \
    ObsIQROutlierRemover, TVxConcepts, InterventionSegmentation, ObsTimeBinning, LeadingObservableExtraction, \
    ExcludeShortAdmissions, TrainableTransformation
...
class TestTrainableTransformer:
    ...
    def scaler_class(self, scalable_table_name) -> type[TrainableTransformation]:
    ...
    def scaled_ehr(self, large_scalable_split_ehr, scaler_class: type[TrainableTransformation]):
        return scaler_class.apply(large_scalable_split_ehr, DATASET_SCHEME_MANAGER, TVxReport())[0]
    ...
    def processed_ehr(self, large_scalable_split_ehr: TVxEHR,
        ...
        return large_scalable_split_ehr._execute_pipeline(
            [ObsIQROutlierRemover(), InputScaler(), ObsAdaptiveScaler()], DATASET_SCHEME_MANAGER)
...
class TestTVxConcepts:
    ...
    def admission_dx_codes(self, tvx_ehr_with_dx: TVxEHR) -> dict[str, CodesVector]:
        return TVxConcepts._dx_discharge(tvx_ehr_with_dx, DATASET_SCHEME_MANAGER)[0]

    @pytest.fixture(scope='class')
    def admission_dx_codeset(self, tvx_ehr_with_dx: TVxEHR) -> dict[str, set[str]]:
        return TVxConcepts._dx_discharge(tvx_ehr_with_dx, DATASET_SCHEME_MANAGER)[1]

    def test_admission_dx_codes(self, tvx_ehr_with_dx: TVxEHR,
    ...
    def admission_dx_history_codes(self, tvx_ehr_with_dx: TVxEHR,
        ...
        return TVxConcepts._dx_discharge_history(tvx_ehr_with_dx, DATASET_SCHEME_MANAGER, admission_dx_codes)
    ...
    def admission_outcome(self, tvx_ehr_with_dx: TVxEHR,
        ...
        return TVxConcepts._outcome(tvx_ehr_with_dx, DATASET_SCHEME_MANAGER, admission_dx_codeset)
    ...
    def admission_icu_inputs(self, tvx_ehr_with_icu_inputs: TVxEHR) -> dict[str, InpatientInput]:
        return TVxConcepts._icu_inputs(tvx_ehr_with_icu_inputs, DATASET_SCHEME_MANAGER)
    ...
    def admission_obs(self, tvx_ehr_with_obs: TVxEHR) -> dict[
        str, InpatientObservables]:
        return TVxConcepts._observables(tvx_ehr_with_obs, DATASET_SCHEME_MANAGER, TVxReport())[0]

    def test_admission_obs(self, tvx_ehr_with_obs: TVxEHR,
                           admission_obs: dict[str, InpatientObservables]):
    ...
    def admission_hosp_procedures(self, tvx_ehr_with_hosp_procedures: TVxEHR) -> dict[str, InpatientInput]:
        return TVxConcepts._hosp_procedures(tvx_ehr_with_hosp_procedures, DATASET_SCHEME_MANAGER)
    ...
    def admission_icu_procedures(self, tvx_ehr_with_icu_procedures: TVxEHR) -> dict[str, InpatientInput]:
        return TVxConcepts._icu_procedures(tvx_ehr_with_icu_procedures, DATASET_SCHEME_MANAGER)
    ...
    def admission_interventions(self, tvx_ehr_with_all_interventions: TVxEHR) -> dict[str, InpatientInterventions]:
        return TVxConcepts._interventions(tvx_ehr_with_all_interventions, DATASET_SCHEME_MANAGER, TVxReport())[0]
    ...
    def tvx_ehr_concept(self, tvx_ehr_conf_concept: TVxEHR):
        return tvx_ehr_conf_concept._execute_pipeline([TVxConcepts()], DATASET_SCHEME_MANAGER)
...
class TestInterventionSegmentation:
    ...
    def tvx_ehr_segmented(self, tvx_ehr_concept: TVxEHR) -> SegmentedTVxEHR:
        ...
        return tvx_ehr_concept._execute_pipeline([InterventionSegmentation()], DATASET_SCHEME_MANAGER)
...
class TestObsTimeBinning:
    ...
    def tvx_ehr_binned(self, tvx_ehr_concept: TVxEHR) -> TVxEHR:
        tvx_ehr_concept = eqx.tree_at(lambda x: x.config.time_binning, tvx_ehr_concept, 12.0,
                                      is_leaf=lambda x: x is None)
        return tvx_ehr_concept._execute_pipeline([ObsTimeBinning()], DATASET_SCHEME_MANAGER)
...
class TestLeadExtraction:
    ...
    def tvx_ehr_lead(self, tvx_ehr_concept: TVxEHR) -> TVxEHR:
        ...
        return tvx_ehr_concept._execute_pipeline([LeadingObservableExtraction()], DATASET_SCHEME_MANAGER)
...
class TestExcludeShortAdmissions:
    ...
    def tvx_ehr_filtered(self, tvx_ehr_concept: TVxEHR) -> TVxEHR:
        return tvx_ehr_concept._execute_pipeline([ExcludeShortAdmissions()], DATASET_SCHEME_MANAGER)
