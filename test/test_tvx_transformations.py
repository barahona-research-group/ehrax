...
class TestTrainableTransformer:
    ...
    def numerical_processor_config(self, request) -> rx.DatasetNumericalProcessorsConfig:
        ...
        scalers_conf = rx.ScalersConfig(obs=rx.ScalerConfig(use_float16=True),
                                        icu_inputs=rx.ScalerConfig(use_float16=True))
    ...
    def large_scalable_split_ehr(self, tvx_ehr: rx.TVxEHR, scalable_table_name: str, use_float16: bool):
        ...
        tvx_ehr = eqx.tree_at(
            ...
            tvx_ehr, rx.ScalerConfig(use_float16=use_float16),
            is_leaf=lambda x: x is None)
        return tvx_ehr
    ...
    def test_trainable_transformer(self, large_scalable_split_ehr: rx.TVxEHR,
                                   scaled_ehr: rx.TVxEHR,
    ...
    @pytest.fixture(scope='class')
    def processed_ehr(self, large_scalable_split_ehr: rx.TVxEHR,
                      numerical_processor_config: rx.DatasetNumericalProcessorsConfig) -> rx.TVxEHR:
    ...
    def test_numerical_processors_serialization(self, fitted_numerical_processors: rx.DatasetNumericalProcessors,
                                                tmpdir: str):
    ...
    def test_ehr_serialization(self, tvx_ehr: rx.TVxEHR, large_scalable_split_ehr: rx.TVxEHR, processed_ehr: rx.TVxEHR,
                               tmpdir: str):
...
class TestTVxConcepts:
    ...
    @pytest.fixture(scope='class')
    def tvx_ehr_configured_demographic(self, tvx_ehr: rx.TVxEHR,
                                       tvx_ehr_demographic_config: rx.DemographicVectorConfig) -> rx.TVxEHR:
    ...
    def test_tvx_concepts_static(self, tvx_ehr: rx.TVxEHR,
    ...
    def tvx_ehr_with_dx(self, tvx_ehr: rx.TVxEHR) -> rx.TVxEHR:
        ...
        c_admission_id = tvx_ehr.dataset.config.columns.admissions.admission_id_alias
        ...
        return eqx.tree_at(lambda x: x.dataset.columns.dx_discharge, tvx_ehr, dx_discharge)
    ...
    def test_admission_dx_codes(self, tvx_ehr_with_dx: rx.TVxEHR,
    ...
    @pytest.fixture(scope='class')
    def admission_dx_history_codes(self, tvx_ehr_with_dx: rx.TVxEHR,
                                   admission_dx_codes: dict[str, rx.CodesVector]) -> dict[str, rx.CodesVector]:
        return rx.TVxConcepts._dx_discharge_history(tvx_ehr_with_dx, DATASET_SCHEME_MANAGER, admission_dx_codes)

    def test_admission_dx_history_codes(self, tvx_ehr_with_dx: rx.TVxEHR,
                                        admission_dx_codes: dict[str, rx.CodesVector],
    ...
    @pytest.fixture(scope='class')
    def admission_outcome(self, tvx_ehr_with_dx: rx.TVxEHR,
                          admission_dx_codeset: dict[str, set[str]]) -> dict[str, rx.CodesVector]:
        return rx.TVxConcepts._outcome(tvx_ehr_with_dx, DATASET_SCHEME_MANAGER, admission_dx_codeset)

    def test_admission_outcome(self, tvx_ehr_with_dx: rx.TVxEHR,
                               admission_dx_codes: dict[str, rx.CodesVector],
    ...
    def test_admission_icu_inputs(self, tvx_ehr_with_icu_inputs: rx.TVxEHR,
        ...
        c_admission_id = tvx_ehr_with_icu_inputs.dataset.config.columns.admissions.admission_id_alias
        ...
        for admission_id, admission_inputs_df in icu_inputs.groupby(c_admission_id):
            ...
            assert all(tvx_inputs.code_index < len(
    ...
    @pytest.fixture(scope='class')
    def admission_obs(self, tvx_ehr_with_obs: rx.TVxEHR) -> dict[
        str, rx.InpatientObservables]:
    ...
    def test_admission_obs(self, tvx_ehr_with_obs: rx.TVxEHR,
        ...
        c_admission_id = tvx_ehr_with_obs.dataset.config.columns.admissions.admission_id_alias
    ...
    def test_admission_hosp_procedures(self, tvx_ehr_with_hosp_procedures: rx.TVxEHR,
        ...
        c_admission_id = tvx_ehr_with_hosp_procedures.dataset.config.columns.admissions.admission_id_alias
        ...
        for admission_id, admission_hosp_procedures_df in hosp_procedures.groupby(c_admission_id):
            ...
            assert all(tvx_hosp_proc.code_index < len(
    ...
    def test_admission_icu_procedures(self, tvx_ehr_with_icu_procedures: rx.TVxEHR,
        ...
        c_admission_id = tvx_ehr_with_icu_procedures.dataset.config.columns.admissions.admission_id_alias
        ...
        for admission_id, admission_icu_procedures_df in icu_procedures.groupby(c_admission_id):
            ...
            assert all(tvx_icu_proc.code_index < len(
    ...
    @pytest.fixture(scope='class')
    def admission_interventions(self, tvx_ehr_with_all_interventions: rx.TVxEHR) -> dict[
        str, rx.InpatientInterventions]:
        return rx.TVxConcepts._interventions(tvx_ehr_with_all_interventions, DATASET_SCHEME_MANAGER, rx.TVxReport())[0]

    def test_admission_interventions(self, tvx_ehr_with_all_interventions: rx.TVxEHR,
                                     admission_interventions: dict[str, rx.InpatientInterventions]):
    ...
    def test_ehr_serialization(self, tvx_ehr_conf_concept: rx.TVxEHR, tvx_ehr_concept: rx.TVxEHR,
...
class TestInterventionSegmentation:
    ...
    @pytest.fixture(scope='class')
    def tvx_ehr_segmented(self, tvx_ehr_concept: rx.TVxEHR) -> rx.SegmentedTVxEHR:
    ...
    def test_segmentation(self, tvx_ehr_concept: rx.TVxEHR, tvx_ehr_segmented: rx.SegmentedTVxEHR):
    ...
    @pytest.fixture(
        ...
        scope='class')
    def mutated_ehr_concept(self, tvx_ehr_segmented: rx.SegmentedTVxEHR, request):
    ...
    def test_ehr_serialization(self, tvx_ehr_concept: rx.TVxEHR, tvx_ehr_segmented: rx.SegmentedTVxEHR,
                               mutated_ehr_concept: rx.SegmentedTVxEHR,
                               tmpdir: str):
...
class TestLeadExtraction:
    ...
    def tvx_ehr_concept(self, tvx_ehr: rx.TVxEHR):
        ...
        lead_config = rx.LeadingObservableExtractorConfig(leading_hours=[1.0, 2.0],
    ...
    def test_ehr_serialization(self, tvx_ehr_concept: rx.TVxEHR, tvx_ehr_lead: rx.TVxEHR,
                               tmpdir: str):
    ...
    @pytest.fixture(params=[
        (lambda tvx: tvx.dataset.columns, rx.DatasetTables),
    ...
    def tvx_ehr_lazy_loaded(self, tvx_ehr_lead, tmpdir: str,
                            tvx_ehr_defer_getters: tuple[Callable[[rx.TVxEHR], Any], type]) -> rx.TVxEHR:
    ...
    def test_lazy_loading(self, tvx_ehr_lead: rx.TVxEHR, tvx_ehr_lazy_loaded: rx.TVxEHR,
        ...
        assert all(
            isinstance(child, rx.HDFVirtualNode) for child in
            eqx.tree_flatten_one_level(getter(tvx_ehr_lazy_loaded))[0])
